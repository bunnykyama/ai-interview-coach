...
export class Backend implements backendInterface {
    ...
    async createInterviewSession(arg0: InterviewSession): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getInterviewSessions(): Promise<Array<InterviewSession>> {
        if (this.processError) {
            try {
                const result = await this.actor.getInterviewSessions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async seedInterviewSessions(): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.seedInterviewSessions();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
